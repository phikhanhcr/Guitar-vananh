  ...
  return (
    <div className='col-lg-4 col-md-6 col-sm-6' >
      <div className="product-item bg-f6f6f6 pb-15 ">
        <a href={`/all-product/${product.groupInstrument.linkRef}/${product.linkRef}`} className="link-ref t1">
        ...
        <div className="product-over p-3 text-center" >
          <a href={`/all-product/${product.groupInstrument.linkRef}/${product.linkRef}`} className="mr-3">
